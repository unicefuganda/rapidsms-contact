...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('contact_flag_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('flag', models.ForeignKey(orm['contact.flag'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('contact_flag_groups', ['flag_id', 'group_id'])


    def backwards(self, orm):
        # Removing M2M table for field groups on 'Flag'
        db.delete_table('contact_flag_groups')
    ...
    models = {
        ...
        'contact.flag': {
            ...
            'groups': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'flags'", 'symmetrical': 'False', 'to': "orm['auth.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
